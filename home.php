...
<div class="container">
    ...
    <div class="table-responsive">
        <?php
        $selectQuery = "SELECT *,(SELECT city.cityname from city WHERE city.id=flights.sourcecity)
 as sourcecityname,(SELECT city.cityname from city WHERE city.id=flights.destinationcity) 
 as destinationcityname FROM `booking` INNER JOIN flights ON flights.fid=booking.flightid 
 INNER JOIN user ON user.email=booking.email  order  by `booking`.`id` DESC";
